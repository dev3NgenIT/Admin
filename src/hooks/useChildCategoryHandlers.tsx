...
import { ChildCategoryData } from "../http/childCategory";

// useUsersHandlers.tsx
export const useChildCategoryHandlers = (data: ChildCategoryData[]) => {
  ...
  const searchedData = data.filter(
    (user) =>
      (user.child_category_name
        ? user.child_category_name.toLowerCase()
        : "" + " " + user.child_category_name?.toLowerCase()
