...
import { getAllProducts, Products } from "../../../../http/products";
...
const AllProducts = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (!products) return console.log("brand missing");
      setData(products);
    })();
  }, []);
  ...
  return (
    <div className="px-4 mx-auto container-full">
      <div className="p-5">
        ...
        <div className="card bg-base-100">
          <div className="flex flex-col items-center justify-between p-3 sm:flex-row card-header">
            <h3 className="mb-3 text-2xl card-title sm:mb-0">Product List</h3>
            <div>
              <Link to={"create"}>
          ...
          <div className="p-0 card-body">
            <div className="">
              {/* Pass the data to productsList to show in DataTable */}
